...
export const TemplateSchema = z.object({
  ...
  // .default() lets templates saved before bleed/safe-zone/cardBack existed
  // keep loading — missing keys are filled in rather than rejected.
  ...
  cardBack: z
    ...
    .default(() => ({ assetId: null, color: '#ffffff' })),
});
